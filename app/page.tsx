  ...
  return (
    <div className="flex min-h-screen flex-col">
      <div className="mx-auto w-full max-w-7xl flex-1 px-4 py-8 sm:px-6 lg:px-8">
        <h1 className="text-3xl font-bold text-center">PickMyClasses - Student Timetable Generator</h1>
        <div className="mb-4">
          <button
            onClick={() => setIsExpanded(!isExpanded)}
            className="flex items-center gap-2 py-2 text-sm text-gray-500 hover:text-gray-700 text-center mx-auto"
          >
            <svg
